...
- [ ] 목록 화면 > 상단 gitnote 앱이름과 버튼들이 안드로이드 기본 노티바에 가려짐
  - [ ] 스크린샷 참고 : listview-top-button-bug.png, editview-cancle-save-button-too-small.png 2개 스크린샷 참고하여 수정
- [ ] 수정 화면 > 앱 상단이 노티바에 가려짐
- [ ] 수정 화면 > 취소, 저장 버튼이 너무 작음
